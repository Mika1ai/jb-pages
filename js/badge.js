...
const badges = document.querySelectorAll(".badge__badge");

for (let i = 0; i < badges.length; i++) {
  // inscription
  const inscrBtn = badges[i].querySelectorAll(".badge__badge-inscription");
  const inscrField = badges[i].querySelector(".badge__inscription");
  ...
  // colors
  const colorsBtn = badges[i].querySelectorAll(".badge__badge-color");
  ...
  // copy
  const copyBtn = badges[i].querySelector(".badge__badge-copy");
